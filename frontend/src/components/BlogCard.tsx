...
export const BlogCard = ({
    ...
    <div className="p-4 border-b-2 border-slate-200 pb-4  w-screen max-w-screen-md cursor-pointer">
        ...
        <Avatar name={authorName} />
                <div className = "font-extralight   text-sm flex-col flex justify-center flex-col">
                {authorName}
                </div>
                <div className="font-extralight pl-2  text-sm flex-col pl-2 flex justify-center flex-col">
                    <Circle />
                </div>
                ...
                <div className="text-slate-400 h-1 text-sm font-thin pt-4 pb-4">
